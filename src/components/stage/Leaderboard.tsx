...
export function Leaderboard({ players, eventType }: LeaderboardProps) {
  ...
  return (
    <div className="w-full max-w-5xl mx-auto space-y-6">
      {/* #1 — huge with gold crown */}
      <motion.div
        initial={{ scale: 0.6, opacity: 0, y: 20 }}
        animate={{ scale: 1, opacity: 1, y: 0 }}
        transition={{ type: 'spring', stiffness: 220, damping: 18, delay: 0.1 }}
        className="panel-strong p-8 flex flex-col items-center text-center gap-4"
      >
        ...
        <div className="font-display font-black gold-shimmer text-6xl leading-none">
          {first.display_name}
        </div>
